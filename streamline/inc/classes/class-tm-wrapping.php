 ...
 */
add_filter( 'template_include', array( 'streamline_Wrapping', 'wrap' ), 99 );
add_filter( 'streamline_wrap_base', 'streamline_wrap_base_cpts' );
 ...
 */
function streamline_template_path() {
	return streamline_Wrapping::$main_template;
}
 ...
 */
function streamline_template_base() {
	return streamline_Wrapping::$base;
}

if ( ! class_exists( 'streamline_Wrapping' ) ) {
	...
	class streamline_Wrapping {
		...
		/**
		 * Initialize new instance of streamline_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'streamline_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in streamline_Wrapping class.
		 *
		 * @since 4.0.0
		...
		public static function wrap( $main ) {
			...
			return new streamline_Wrapping();
		}
	}
}
 ...
 */
function streamline_wrap_base_cpts( $templates ) {
