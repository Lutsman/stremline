...
if ( ! class_exists( 'streamline_Widget_Area' ) ) {

	class streamline_Widget_Area {
		...
		*/
		function __construct( $widgets_settings = array() ) {
			...
			$widgets_default_settings = apply_filters( 'tm_widget_area_default_settings', array(
				'sidebar-primary' => array(
					'name'           => esc_html__( 'Sidebar', 'streamline' ),
					'description'    => '',
				...
				'full-width-header-area' => array(
					'name'           => esc_html__( 'Full width header area', 'streamline' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
				...
				'before-content-area' => array(
					'name'           => esc_html__( 'Before content widget area', 'streamline' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
				...
				'before-loop-area' => array(
					'name'           => esc_html__( 'Before loop widget area', 'streamline' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
				...
				'after-loop-area' => array(
					'name'           => esc_html__( 'After loop widget area', 'streamline' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
				...
				'after-content-area' => array(
					'name'           => esc_html__( 'After content widget area', 'streamline' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
				...
				'after-content-full-width-area' => array(
					'name'           => esc_html__( 'After content full width widget area', 'streamline' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
				...
				'footer-area' => array(
					'name'           => esc_html__( 'Footer widget area', 'streamline' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
			...
			add_action( 'streamline_render_widget_area', array( $this, 'render_widget_area' ) );
		}
		...
		public function render_widget_area( $area_id ) {
			...
			$area_id        = apply_filters( 'streamline_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'streamline_widget_area_classes', $classes, $area_id );
	...
	function streamline_widget_area() {
		return streamline_Widget_Area::get_instance();
	}

	streamline_widget_area();
}
